...
class TestNxapiShowCommands:
    ...
    def test_get_model_from_json_tor(self):
        ...
        nxapi_conn = nxapi.NXAPI(example_ip, example_username, example_password)
        nxapi_conn._get_model_from_json(nxapi_expected_outputs.NXAPI_SHOW_MODULE_TOR_OUTPUT)
        
        assert nxapi_conn.model == "N9K-C93180YC-FX"
        assert nxapi_conn.modules == [nxapi_expected_outputs.NXAPI_SHOW_MODULE_TOR_OUTPUT["ins_api"]["outputs"]["output"]["body"]["TABLE_modinfo"]["ROW_modinfo"]]
    ...
    def test_get_model_from_json_eor(self):
        ...
        nxapi_conn = nxapi.NXAPI(example_ip, example_username, example_password)
        nxapi_conn._get_model_from_json(nxapi_expected_outputs.NXAPI_SHOW_MODULE_EOR_OUTPUT)

        assert nxapi_conn.model == "N9K-C9500"
        assert nxapi_conn.modules == nxapi_expected_outputs.NXAPI_SHOW_MODULE_EOR_OUTPUT["ins_api"]["outputs"]["output"]["body"]["TABLE_modinfo"]["ROW_modinfo"]
    ...
    def test_get_version_from_json_tor(self):
        ...
        nxapi_conn = nxapi.NXAPI(example_ip, example_username, example_password)
        nxapi_conn._get_nxos_version_from_json(nxapi_expected_outputs.NXAPI_SHOW_MODULE_TOR_OUTPUT)
    ...
    def test_get_version_from_json_eor(self):
        ...
        nxapi_conn = nxapi.NXAPI(example_ip, example_username, example_password)
        nxapi_conn._get_nxos_version_from_json(nxapi_expected_outputs.NXAPI_SHOW_MODULE_EOR_OUTPUT)
